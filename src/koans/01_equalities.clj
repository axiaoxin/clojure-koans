...
(meditations
  ...
  (= true (== 2.0 2))
  ;== is a type independent way of comparing numbers. If either of its arguments is not a number, it will always return false
  ...
  (not= :fill-in-the-blank :_keyword '_symbol))
